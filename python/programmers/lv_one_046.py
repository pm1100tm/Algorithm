...
class Solution:
    ...
    def my_solution(self, n: int, arr1: List[int], arr2: List[int]) -> List[str]:
        answer = []
    ...
    def other_solution_one(self, n: int, arr1: List[int], arr2: List[int]) -> List[str]:
        answer = []
    ...
    def other_solution_two(self, n: int, arr1: List[int], arr2: List[int]) -> List[str]:
        answer = ["#"] * n
    ...
    def other_solution_three(self, n: int, arr1: List[int], arr2: List[int]) -> List[str]:
        result = []
...
class TestSolution(unittest.TestCase):
    ...
    def test_my_solution(self):
        result_one = self.solution.my_solution(
            self.case_one[0],
            self.case_one[1],
            self.case_one[2]
        )
        ...
        result_two = self.solution.my_solution(
            self.case_two[0],
            self.case_two[1],
            self.case_two[2]
        )
    ...
    def test_other_solution_two(self):
        result_one = self.solution.other_solution_two(
            self.case_one[0],
            self.case_one[1],
            self.case_one[2]
        )
        ...
        result_two = self.solution.other_solution_two(
            self.case_two[0],
            self.case_two[1],
            self.case_two[2]
        )
