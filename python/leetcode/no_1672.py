...
has the j(th) bank. Return the wealth that the richest customer has.
...
class Solution:
    ...
    @CommonUtils.logging_time
    def maximum_wealth_3(self, accounts: List[List[int]]) -> int:
        max_wealth = 0
...
if __name__ == "__main__":
    ...
    print(solution.maximum_wealth_1(accounts_1))
    print(solution.maximum_wealth_2(accounts_1))
    print(solution.maximum_wealth_3(accounts_1))